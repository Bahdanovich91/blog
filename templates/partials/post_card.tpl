<article class="post-card">
    {if $post.image}
        <a href="{$base_url}/post/{$post.slug|escape}" class="post-card__image-wrap">
    ...
    <div class="post-card__body">
        <h3 class="post-card__title">
            <a href="{$base_url}/post/{$post.slug|escape}">{$post.title|escape}</a>
        </h3>
        ...
        <a href="{$base_url}/post/{$post.slug|escape}" class="post-card__link">Continue Reading</a>
    </div>
</article>
